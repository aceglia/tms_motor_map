...
if __name__ == "__main__":
    ...
    data_frame_tmp = data_frame_tmp.loc[
        ~((data_frame_tmp["condition"] == "pseudo") & (data_frame_tmp["map_number"].isin(map_num)))
    ]
    ...
    for c, cond in enumerate(data_frame_tmp["condition"].unique()):
        ...
        for m, map_number in enumerate(map_number_list_tmp):
            data_frame_tmp_map = data_frame_tmp.loc[
                (data_frame_tmp["condition"] == cond) & (data_frame_tmp["map_number"] == map_number)
            ]
